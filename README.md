<table>
  <tr>
    <td width="140"><img src="photo.JPG" alt="Xiangwen (Wayne) Yang" width="120" style="border-radius:50%"></td>
    <td>
...
### Highlights
- 5+ blockchain systems (supply chain, pharmaceuticals, agriculture) · 9+ co-authored publications (NDSS, ICML, ACM AsiaCCS) · 7+ domains (Agriculture, Healthcare, Law Enforcement, Energy, Transport, Cybersecurity, Supply Chain) · 10% solar PV efficiency gain via ML · 3M+ records analyzed (crime analytics)

---

## Professional Experience
- <strong>Senior Software Engineer</strong>, Monash University · Australia · Dec 2020–Present — Lead blockchain security projects; ship production systems; manage 2–3 concurrent cross-domain deliveries.
- <strong>Data Analyst</strong>, Monash University · Australia · Dec 2020–May 2024 — Solar PV efficiency analytics; sensitive crime data modeling (emerging trend detection).
...
- <strong>Pharma Supply Chain (Algorand)</strong> · Dev & Research · Nov 2021–May 2022 — IoT-integrated testnet prototype; multi-party trust, cold-chain compliance, enterprise interoperability.
- <strong>AgriFuture</strong> · Solutions Architect · Jul 2021–Feb 2022 — Sector-specific blockchain use-cases (tea tree oil, equine, apiarists); market access & operational efficiency.
- <strong>Fleet Telemetry</strong> · Data · Dec 2019–Nov 2020 — Fuel/safety analytics; over-idle detection; cost reduction & compliance.
...
- [ICML'23] Demystifying Uneven Vulnerability of Link Stealing Attacks against GNNs — He Zhang, Bang Wu, <strong>Xiangwen Yang</strong>, et al.
- [ACM AsiaCCS'23] A New Look at Blockchain Leader Election: Simple, Efficient, Sustainable and Post-Quantum — Esgin, Ersoy, <strong>Yang</strong>, et al.
- [ACM AsiaCCS'22] Model Extraction Attacks on Graph Neural Networks: Taxonomy and Realisation — Wu, <strong>Yang</strong>, Pan, Yuan.
